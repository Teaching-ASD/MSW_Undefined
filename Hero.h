...
public:
    ...
    Hero(const std::string&/**< [in] The Hero's name */,int/**< [in] The Hero's health */,const int/**< [in] The Hero's damage */,const double/**< [in] The Hero's attackcooldown */,const int/**< [in] The Hero's Experience per Level */, const int /**< [in] The Hero's HealthPoint Bonus per Level */, const int /**< [in] The Hero's Damage Bonus per Level */, const double /**< [in] The Hero's Cooldown Multiplier per Level */);
